...
class StreamTest {
  StreamTest._();
   ...
   StreamController<SignUpUser> signUpUserStreamController =  StreamController<SignUpUser>.broadcast();
   StreamController<ResultLogin> loginUserStreamController =  StreamController<ResultLogin>.broadcast();
