    ...
    return showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        actions: [
          ...
          ,
          TextButton(onPressed: () => Navigator.of(context).pop(true), child: Text(defaultActionText)),
        ],
      ),
    );
  }
  return showCupertinoDialog(
    ...
    builder: (context) => AlertDialog(
      ...
      actions: [
        ...
        ,
        CupertinoDialogAction(onPressed: () => Navigator.of(context).pop(true), child: Text(defaultActionText)),
      ],
    ),
  );
}