...
class PhysioExerciseDetail1 extends StatefulWidget {
  PhysioExerciseDetail1({Key? key, this.exerciseDetail, this.exerciseResource})
      : super(key: key);
  ExerciseDetail1? exerciseDetail;
  ExerciseResource? exerciseResource;

  @override
  State<PhysioExerciseDetail1> createState() => _PhysioExerciseDetail1State();
}

class _PhysioExerciseDetail1State extends State<PhysioExerciseDetail1> {
