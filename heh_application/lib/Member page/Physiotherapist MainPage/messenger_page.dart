...
class _MessengerPageState extends State<MessengerPage> {
  ...
  bool isMessageSent (int index) {
    if (index > 0 && listMessages[index - 1].get(FirestoreConstants.idFrom) != widget.currentUserID || index ==0){
      return true;
    }
    else {
      return false;
  ...
  void onSendMessage (String content, int type){
    if (content.trim().isNotEmpty){
      ...
      ChatProvider().sendChatMessage(groupChatID,content, type, widget.currentUserID, widget.oponentID);
