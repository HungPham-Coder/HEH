                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return BackMenu(
                          ...
                          press: () async {
                           ExerciseDetail1 exerciseDetail =  await CallAPI().getExerciseDetailByExerciseID(snapshot.data![index].exerciseID);
                           ExerciseResource exerciseResource = await CallAPI().getExerciseResourceByExerciseDetailID(exerciseDetail.exerciseDetailID);
                           Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) {
                                      if (exerciseDetail != null){
                                        return ExerciseDetail(exerciseDetail: exerciseDetail,exerciseResource: exerciseResource,);
                                      }
                                      else {
